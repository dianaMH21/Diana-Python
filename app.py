...
def mostrar_detalle_movil_general():
    ...
    with tab1:
        ...
        if df_filtrado.empty:
            ...
            st.download_button(
                ...
                on_click=registrar_descarga,
                args=("Detalle Móvil General", "detalle_movil_general.xlsx", f"Fecha Venta: {filtro_mes} | Canal: {', '.join(sel_canal) if sel_canal else 'Todos'}")
            )
    ...
    with tab5:
        mostrar_ranking_departamentos_movil_gerencial(df_filtrado, filtro_mes, filtro_canal)
